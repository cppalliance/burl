...
struct options_test
{
    ...
    void
    test_verify_config_aggregate_init()
    {
        verify_config v{
            .verify_peer = false,
    ...
    void
    test_request_options_with_values()
    {
        request_options opts;
...
TEST_SUITE(options_test, "boost.burl.options");
