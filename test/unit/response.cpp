...
struct response_test
{
    void
    test_response_members()
    {
    ...
    void
    test_response_convenience_accessors()
    {
        response<std::string> r;
    ...
    void
    test_streamed_response_members()
    {
        streamed_response r;
    ...
    void
    test_streamed_response_accessors()
    {
        streamed_response r;
