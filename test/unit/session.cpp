...
struct session_test
{
    ...
    void
    test_request_method_signatures()
    {
        corosio::io_context ioc;
        corosio::tls_context tls_ctx;
        session s(ioc, tls_ctx);
...
TEST_SUITE(session_test, "boost.burl.session");
