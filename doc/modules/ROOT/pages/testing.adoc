...
* xref:2.guide/2c.responses.adoc[Responses] — The body functions that a
  synthesized response feeds
* xref:2.guide/2d.error-handling.adoc[Error Handling] — The failures a fuse
  helps you cover
